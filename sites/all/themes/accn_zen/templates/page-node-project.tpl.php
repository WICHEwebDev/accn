<?php
// $Id: page.tpl.php,v 1.1 2011/03/15 19:06:13 rdahiya Exp $
...
<div id="header-logos"> 
    ...
    <div id="main-wrapper"><div id="main" class="clearfix<?php if ($primary_links || $navigation) { print ' with-navigation'; } ?>">
       <div id="main-tabs"><?php print $main_tabs; ?></div> 
        ...
        <?php if ($title): ?>
        <!-- WICHE: Add link to project if exists. -pmitchell 11/7/11 -->
        <?php if (!empty($node->field_lumina_project_url)) print '<a href="' . $node->field_lumina_project_url[0]['url'] . '">'; ?>
          <h1 class="title"><?php print $title; ?></h1>
        <?php if (!empty($node->field_lumina_project_url)) print '</a>'; ?>
		<!-- WICHE END: -->
        <?php endif; ?>
        <?php print $messages; ?>
      <?php if ($tabs): ?>
